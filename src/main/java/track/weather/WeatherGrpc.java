...
public final class WeatherGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<track.weather.WeatherLocation,
      track.weather.TemperatureResponse> getGetTemperatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetTemperature",
      requestType = track.weather.WeatherLocation.class,
      responseType = track.weather.TemperatureResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<track.weather.WeatherLocation,
      track.weather.TemperatureResponse> getGetTemperatureMethod() {
    io.grpc.MethodDescriptor<track.weather.WeatherLocation, track.weather.TemperatureResponse> getGetTemperatureMethod;
      ...
      synchronized (WeatherGrpc.class) {
        if ((getGetTemperatureMethod = WeatherGrpc.getGetTemperatureMethod) == null) {
          WeatherGrpc.getGetTemperatureMethod = getGetTemperatureMethod = 
              io.grpc.MethodDescriptor.<track.weather.WeatherLocation, track.weather.TemperatureResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Weather.Weather", "GetTemperature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.WeatherLocation.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.TemperatureResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<track.weather.WeatherLocation,
      track.weather.HumidityResponse> getGetHumidityMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHumidity",
      requestType = track.weather.WeatherLocation.class,
      responseType = track.weather.HumidityResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<track.weather.WeatherLocation,
      track.weather.HumidityResponse> getGetHumidityMethod() {
    io.grpc.MethodDescriptor<track.weather.WeatherLocation, track.weather.HumidityResponse> getGetHumidityMethod;
    if ((getGetHumidityMethod = WeatherGrpc.getGetHumidityMethod) == null) {
      synchronized (WeatherGrpc.class) {
        if ((getGetHumidityMethod = WeatherGrpc.getGetHumidityMethod) == null) {
          WeatherGrpc.getGetHumidityMethod = getGetHumidityMethod = 
              io.grpc.MethodDescriptor.<track.weather.WeatherLocation, track.weather.HumidityResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.WeatherLocation.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.HumidityResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<track.weather.WeatherForecastRequest,
      track.weather.WeatherForecastResponse> getGetWeatherForecastMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetWeatherForecast",
      requestType = track.weather.WeatherForecastRequest.class,
      responseType = track.weather.WeatherForecastResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<track.weather.WeatherForecastRequest,
      track.weather.WeatherForecastResponse> getGetWeatherForecastMethod() {
    io.grpc.MethodDescriptor<track.weather.WeatherForecastRequest, track.weather.WeatherForecastResponse> getGetWeatherForecastMethod;
      ...
      synchronized (WeatherGrpc.class) {
        if ((getGetWeatherForecastMethod = WeatherGrpc.getGetWeatherForecastMethod) == null) {
          WeatherGrpc.getGetWeatherForecastMethod = getGetWeatherForecastMethod = 
              io.grpc.MethodDescriptor.<track.weather.WeatherForecastRequest, track.weather.WeatherForecastResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Weather.Weather", "GetWeatherForecast"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.WeatherForecastRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  track.weather.WeatherForecastResponse.getDefaultInstance()))
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                track.weather.WeatherLocation,
                track.weather.TemperatureResponse>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                track.weather.WeatherLocation,
                track.weather.HumidityResponse>(
                  this, METHODID_GET_HUMIDITY)))
          .addMethod(
            getGetWeatherForecastMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                track.weather.WeatherForecastRequest,
                track.weather.WeatherForecastResponse>(
  ...
  public static final class WeatherBlockingStub extends io.grpc.stub.AbstractStub<WeatherBlockingStub> {
     ...
     * </pre>
     */
    public track.weather.TemperatureResponse getTemperature(track.weather.WeatherLocation request) {
     ...
     * </pre>
     */
    public track.weather.HumidityResponse getHumidity(track.weather.WeatherLocation request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public track.weather.WeatherForecastResponse getWeatherForecast(track.weather.WeatherForecastRequest request) {
      return blockingUnaryCall(
  ...
  public static final class WeatherFutureStub extends io.grpc.stub.AbstractStub<WeatherFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<track.weather.TemperatureResponse> getTemperature(
        track.weather.WeatherLocation request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<track.weather.HumidityResponse> getHumidity(
        track.weather.WeatherLocation request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<track.weather.WeatherForecastResponse> getWeatherForecast(
        track.weather.WeatherForecastRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TEMPERATURE:
          serviceImpl.getTemperature((track.weather.WeatherLocation) request,
              (io.grpc.stub.StreamObserver<track.weather.TemperatureResponse>) responseObserver);
          break;
        case METHODID_GET_HUMIDITY:
          serviceImpl.getHumidity((track.weather.WeatherLocation) request,
              (io.grpc.stub.StreamObserver<track.weather.HumidityResponse>) responseObserver);
          break;
        case METHODID_GET_WEATHER_FORECAST:
          serviceImpl.getWeatherForecast((track.weather.WeatherForecastRequest) request,
              (io.grpc.stub.StreamObserver<track.weather.WeatherForecastResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class WeatherBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return track.weather.WeatherImpl.getDescriptor();
    }
