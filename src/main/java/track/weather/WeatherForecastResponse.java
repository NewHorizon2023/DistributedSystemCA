...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              weatherReadings_ = new java.util.ArrayList<track.weather.WeatherReading>();
              mutable_bitField0_ |= 0x00000001;
            }
            weatherReadings_.add(
                input.readMessage(track.weather.WeatherReading.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return track.weather.WeatherImpl.internal_static_Weather_WeatherForecastResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return track.weather.WeatherImpl.internal_static_Weather_WeatherForecastResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            track.weather.WeatherForecastResponse.class, track.weather.WeatherForecastResponse.Builder.class);
  }

  public static final int WEATHER_READINGS_FIELD_NUMBER = 1;
  private java.util.List<track.weather.WeatherReading> weatherReadings_;
  /**
   * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
   */
  public java.util.List<track.weather.WeatherReading> getWeatherReadingsList() {
    return weatherReadings_;
  }
  /**
   * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
   */
  public java.util.List<? extends track.weather.WeatherReadingOrBuilder> 
   ...
   * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
   */
  public track.weather.WeatherReading getWeatherReadings(int index) {
    return weatherReadings_.get(index);
  }
  /**
   * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
   */
  public track.weather.WeatherReadingOrBuilder getWeatherReadingsOrBuilder(
      int index) {
    return weatherReadings_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof track.weather.WeatherForecastResponse)) {
      return super.equals(obj);
    }
    track.weather.WeatherForecastResponse other = (track.weather.WeatherForecastResponse) obj;
  ...
  public static track.weather.WeatherForecastResponse parseFrom(
  ...
  public static track.weather.WeatherForecastResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static track.weather.WeatherForecastResponse parseFrom(
  ...
  public static track.weather.WeatherForecastResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static track.weather.WeatherForecastResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static track.weather.WeatherForecastResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(track.weather.WeatherForecastResponse prototype) {
  ...
  public static final class Builder extends
      ...
      track.weather.WeatherForecastResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return track.weather.WeatherImpl.internal_static_Weather_WeatherForecastResponse_descriptor;
    }
    ...
    // Construct using track.weather.WeatherForecastResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public track.weather.WeatherForecastResponse getDefaultInstanceForType() {
      return track.weather.WeatherForecastResponse.getDefaultInstance();
    }

    @java.lang.Override
    public track.weather.WeatherForecastResponse build() {
      track.weather.WeatherForecastResponse result = buildPartial();
    ...
    @java.lang.Override
    public track.weather.WeatherForecastResponse buildPartial() {
      track.weather.WeatherForecastResponse result = new track.weather.WeatherForecastResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof track.weather.WeatherForecastResponse) {
        return mergeFrom((track.weather.WeatherForecastResponse)other);
      } else {
    ...
    public Builder mergeFrom(track.weather.WeatherForecastResponse other) {
      if (other == track.weather.WeatherForecastResponse.getDefaultInstance()) return this;
      if (weatherReadingsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      track.weather.WeatherForecastResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (track.weather.WeatherForecastResponse) e.getUnfinishedMessage();
    ...
    private void ensureWeatherReadingsIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        weatherReadings_ = new java.util.ArrayList<track.weather.WeatherReading>(weatherReadings_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        track.weather.WeatherReading, track.weather.WeatherReading.Builder, track.weather.WeatherReadingOrBuilder> weatherReadingsBuilder_;
    ...
    public Builder setWeatherReadings(
        int index, track.weather.WeatherReading value) {
      if (weatherReadingsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setWeatherReadings(
        int index, track.weather.WeatherReading.Builder builderForValue) {
      if (weatherReadingsBuilder_ == null) {
        ensureWeatherReadingsIsMutable();
     ...
     * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
     */
    public Builder addWeatherReadings(track.weather.WeatherReading value) {
      if (weatherReadingsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addWeatherReadings(
        track.weather.WeatherReading.Builder builderForValue) {
      if (weatherReadingsBuilder_ == null) {
        ensureWeatherReadingsIsMutable();
    ...
    public Builder addAllWeatherReadings(
        java.lang.Iterable<? extends track.weather.WeatherReading> values) {
      if (weatherReadingsBuilder_ == null) {
        ensureWeatherReadingsIsMutable();
     ...
     * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
     */
    public track.weather.WeatherReading.Builder getWeatherReadingsBuilder(
        int index) {
     ...
     * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
     */
    public track.weather.WeatherReading.Builder addWeatherReadingsBuilder() {
      return getWeatherReadingsFieldBuilder().addBuilder(
          track.weather.WeatherReading.getDefaultInstance());
    }
    /**
     * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
     */
    public track.weather.WeatherReading.Builder addWeatherReadingsBuilder(
        int index) {
      return getWeatherReadingsFieldBuilder().addBuilder(
          index, track.weather.WeatherReading.getDefaultInstance());
    }
    /**
     * <code>repeated .Weather.WeatherReading weather_readings = 1;</code>
     */
    public java.util.List<track.weather.WeatherReading.Builder> 
         getWeatherReadingsBuilderList() {
      return getWeatherReadingsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        track.weather.WeatherReading, track.weather.WeatherReading.Builder, track.weather.WeatherReadingOrBuilder> 
        getWeatherReadingsFieldBuilder() {
      if (weatherReadingsBuilder_ == null) {
  ...
  private static final track.weather.WeatherForecastResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new track.weather.WeatherForecastResponse();
  }

  public static track.weather.WeatherForecastResponse getDefaultInstance() {
