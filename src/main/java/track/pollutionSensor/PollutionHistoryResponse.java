...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              pollutionReadings_ = new java.util.ArrayList<track.pollutionSensor.PollutionReading>();
              mutable_bitField0_ |= 0x00000001;
            }
            pollutionReadings_.add(
                input.readMessage(track.pollutionSensor.PollutionReading.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return track.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return track.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            track.pollutionSensor.PollutionHistoryResponse.class, track.pollutionSensor.PollutionHistoryResponse.Builder.class);
  }

  public static final int POLLUTION_READINGS_FIELD_NUMBER = 1;
  private java.util.List<track.pollutionSensor.PollutionReading> pollutionReadings_;
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public java.util.List<track.pollutionSensor.PollutionReading> getPollutionReadingsList() {
    return pollutionReadings_;
  }
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public java.util.List<? extends track.pollutionSensor.PollutionReadingOrBuilder> 
   ...
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public track.pollutionSensor.PollutionReading getPollutionReadings(int index) {
    return pollutionReadings_.get(index);
  }
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public track.pollutionSensor.PollutionReadingOrBuilder getPollutionReadingsOrBuilder(
      int index) {
    return pollutionReadings_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof track.pollutionSensor.PollutionHistoryResponse)) {
      return super.equals(obj);
    }
    track.pollutionSensor.PollutionHistoryResponse other = (track.pollutionSensor.PollutionHistoryResponse) obj;
  ...
  public static track.pollutionSensor.PollutionHistoryResponse parseFrom(
  ...
  public static track.pollutionSensor.PollutionHistoryResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static track.pollutionSensor.PollutionHistoryResponse parseFrom(
  ...
  public static track.pollutionSensor.PollutionHistoryResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static track.pollutionSensor.PollutionHistoryResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static track.pollutionSensor.PollutionHistoryResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(track.pollutionSensor.PollutionHistoryResponse prototype) {
  ...
  public static final class Builder extends
      ...
      track.pollutionSensor.PollutionHistoryResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return track.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_descriptor;
    }
    ...
    // Construct using track.pollutionSensor.PollutionHistoryResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public track.pollutionSensor.PollutionHistoryResponse getDefaultInstanceForType() {
      return track.pollutionSensor.PollutionHistoryResponse.getDefaultInstance();
    }

    @java.lang.Override
    public track.pollutionSensor.PollutionHistoryResponse build() {
      track.pollutionSensor.PollutionHistoryResponse result = buildPartial();
    ...
    @java.lang.Override
    public track.pollutionSensor.PollutionHistoryResponse buildPartial() {
      track.pollutionSensor.PollutionHistoryResponse result = new track.pollutionSensor.PollutionHistoryResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof track.pollutionSensor.PollutionHistoryResponse) {
        return mergeFrom((track.pollutionSensor.PollutionHistoryResponse)other);
      } else {
    ...
    public Builder mergeFrom(track.pollutionSensor.PollutionHistoryResponse other) {
      if (other == track.pollutionSensor.PollutionHistoryResponse.getDefaultInstance()) return this;
      if (pollutionReadingsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      track.pollutionSensor.PollutionHistoryResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (track.pollutionSensor.PollutionHistoryResponse) e.getUnfinishedMessage();
    ...
    private void ensurePollutionReadingsIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        pollutionReadings_ = new java.util.ArrayList<track.pollutionSensor.PollutionReading>(pollutionReadings_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        track.pollutionSensor.PollutionReading, track.pollutionSensor.PollutionReading.Builder, track.pollutionSensor.PollutionReadingOrBuilder> pollutionReadingsBuilder_;
    ...
    public Builder setPollutionReadings(
        int index, track.pollutionSensor.PollutionReading value) {
      if (pollutionReadingsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setPollutionReadings(
        int index, track.pollutionSensor.PollutionReading.Builder builderForValue) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public Builder addPollutionReadings(track.pollutionSensor.PollutionReading value) {
      if (pollutionReadingsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addPollutionReadings(
        track.pollutionSensor.PollutionReading.Builder builderForValue) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
    ...
    public Builder addAllPollutionReadings(
        java.lang.Iterable<? extends track.pollutionSensor.PollutionReading> values) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public track.pollutionSensor.PollutionReading.Builder getPollutionReadingsBuilder(
        int index) {
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public track.pollutionSensor.PollutionReading.Builder addPollutionReadingsBuilder() {
    ...
    public track.pollutionSensor.PollutionReading.Builder addPollutionReadingsBuilder(
        int index) {
      return getPollutionReadingsFieldBuilder().addBuilder(
          index, track.pollutionSensor.PollutionReading.getDefaultInstance());
    }
    /**
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public java.util.List<track.pollutionSensor.PollutionReading.Builder> 
         getPollutionReadingsBuilderList() {
      return getPollutionReadingsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        track.pollutionSensor.PollutionReading, track.pollutionSensor.PollutionReading.Builder, track.pollutionSensor.PollutionReadingOrBuilder> 
        getPollutionReadingsFieldBuilder() {
      if (pollutionReadingsBuilder_ == null) {
  ...
  private static final track.pollutionSensor.PollutionHistoryResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new track.pollutionSensor.PollutionHistoryResponse();
  }

  public static track.pollutionSensor.PollutionHistoryResponse getDefaultInstance() {
