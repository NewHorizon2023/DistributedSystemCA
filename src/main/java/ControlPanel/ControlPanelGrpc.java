...
public final class ControlPanelGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ControlPanel.DeviceStatusRequest,
      ControlPanel.DeviceStatusResponse> getSetDeviceStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetDeviceStatus",
      requestType = ControlPanel.DeviceStatusRequest.class,
      responseType = ControlPanel.DeviceStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ControlPanel.DeviceStatusRequest,
      ControlPanel.DeviceStatusResponse> getSetDeviceStatusMethod() {
    io.grpc.MethodDescriptor<ControlPanel.DeviceStatusRequest, ControlPanel.DeviceStatusResponse> getSetDeviceStatusMethod;
      ...
      synchronized (ControlPanelGrpc.class) {
        if ((getSetDeviceStatusMethod = ControlPanelGrpc.getSetDeviceStatusMethod) == null) {
          ControlPanelGrpc.getSetDeviceStatusMethod = getSetDeviceStatusMethod = 
              io.grpc.MethodDescriptor.<ControlPanel.DeviceStatusRequest, ControlPanel.DeviceStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ControlPanel.ControlPanel", "SetDeviceStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceStatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceStatusResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier,
      ControlPanel.DeviceStatusResponse> getGetDeviceStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDeviceStatus",
      requestType = ControlPanel.DeviceIdentifier.class,
      responseType = ControlPanel.DeviceStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier,
      ControlPanel.DeviceStatusResponse> getGetDeviceStatusMethod() {
    io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier, ControlPanel.DeviceStatusResponse> getGetDeviceStatusMethod;
      ...
      synchronized (ControlPanelGrpc.class) {
        if ((getGetDeviceStatusMethod = ControlPanelGrpc.getGetDeviceStatusMethod) == null) {
          ControlPanelGrpc.getGetDeviceStatusMethod = getGetDeviceStatusMethod = 
              io.grpc.MethodDescriptor.<ControlPanel.DeviceIdentifier, ControlPanel.DeviceStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ControlPanel.ControlPanel", "GetDeviceStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceIdentifier.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceStatusResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier,
      ControlPanel.DeviceLog> getStreamDeviceLogsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamDeviceLogs",
      requestType = ControlPanel.DeviceIdentifier.class,
      responseType = ControlPanel.DeviceLog.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier,
      ControlPanel.DeviceLog> getStreamDeviceLogsMethod() {
    io.grpc.MethodDescriptor<ControlPanel.DeviceIdentifier, ControlPanel.DeviceLog> getStreamDeviceLogsMethod;
      ...
      synchronized (ControlPanelGrpc.class) {
        if ((getStreamDeviceLogsMethod = ControlPanelGrpc.getStreamDeviceLogsMethod) == null) {
          ControlPanelGrpc.getStreamDeviceLogsMethod = getStreamDeviceLogsMethod = 
              io.grpc.MethodDescriptor.<ControlPanel.DeviceIdentifier, ControlPanel.DeviceLog>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceIdentifier.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlPanel.DeviceLog.getDefaultInstance()))
  ...
  public static abstract class ControlPanelImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void setDeviceStatus(ControlPanel.DeviceStatusRequest request,
        io.grpc.stub.StreamObserver<ControlPanel.DeviceStatusResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getDeviceStatus(ControlPanel.DeviceIdentifier request,
        io.grpc.stub.StreamObserver<ControlPanel.DeviceStatusResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ControlPanel.DeviceIdentifier> streamDeviceLogs(
        io.grpc.stub.StreamObserver<ControlPanel.DeviceLog> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ControlPanel.DeviceStatusRequest,
                ControlPanel.DeviceStatusResponse>(
                  this, METHODID_SET_DEVICE_STATUS)))
          .addMethod(
            getGetDeviceStatusMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                ControlPanel.DeviceIdentifier,
                ControlPanel.DeviceStatusResponse>(
  ...
  public static final class ControlPanelBlockingStub extends io.grpc.stub.AbstractStub<ControlPanelBlockingStub> {
     ...
     * </pre>
     */
    public ControlPanel.DeviceStatusResponse setDeviceStatus(ControlPanel.DeviceStatusRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ControlPanel.DeviceStatusResponse> getDeviceStatus(
        ControlPanel.DeviceIdentifier request) {
  ...
  public static final class ControlPanelFutureStub extends io.grpc.stub.AbstractStub<ControlPanelFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ControlPanel.DeviceStatusResponse> setDeviceStatus(
        ControlPanel.DeviceStatusRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SET_DEVICE_STATUS:
          serviceImpl.setDeviceStatus((ControlPanel.DeviceStatusRequest) request,
              (io.grpc.stub.StreamObserver<ControlPanel.DeviceStatusResponse>) responseObserver);
          break;
        case METHODID_GET_DEVICE_STATUS:
          serviceImpl.getDeviceStatus((ControlPanel.DeviceIdentifier) request,
              (io.grpc.stub.StreamObserver<ControlPanel.DeviceStatusResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ControlPanelBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ControlPanel.ControlPanelImpl.getDescriptor();
    }
