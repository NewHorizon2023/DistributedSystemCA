...
public final class Service4Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<base.service4.RequestMessage,
      base.service4.ResponseMessage> getService4DoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "service4_do",
      requestType = base.service4.RequestMessage.class,
      responseType = base.service4.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<base.service4.RequestMessage,
      base.service4.ResponseMessage> getService4DoMethod() {
    io.grpc.MethodDescriptor<base.service4.RequestMessage, base.service4.ResponseMessage> getService4DoMethod;
      ...
      synchronized (Service4Grpc.class) {
        if ((getService4DoMethod = Service4Grpc.getService4DoMethod) == null) {
          Service4Grpc.getService4DoMethod = getService4DoMethod = 
              io.grpc.MethodDescriptor.<base.service4.RequestMessage, base.service4.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "service4.Service4", "service4_do"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  base.service4.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  base.service4.ResponseMessage.getDefaultInstance()))
  ...
  public static abstract class Service4ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void service4Do(base.service4.RequestMessage request,
        io.grpc.stub.StreamObserver<base.service4.ResponseMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                base.service4.RequestMessage,
                base.service4.ResponseMessage>(
  ...
  public static final class Service4BlockingStub extends io.grpc.stub.AbstractStub<Service4BlockingStub> {
    ...
    /**
     */
    public base.service4.ResponseMessage service4Do(base.service4.RequestMessage request) {
  ...
  public static final class Service4FutureStub extends io.grpc.stub.AbstractStub<Service4FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<base.service4.ResponseMessage> service4Do(
        base.service4.RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SERVICE4_DO:
          serviceImpl.service4Do((base.service4.RequestMessage) request,
              (io.grpc.stub.StreamObserver<base.service4.ResponseMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class Service4BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return base.service4.Service4Impl.getDescriptor();
    }
