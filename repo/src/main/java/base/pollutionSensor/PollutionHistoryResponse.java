...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              pollutionReadings_ = new java.util.ArrayList<base.pollutionSensor.PollutionReading>();
              mutable_bitField0_ |= 0x00000001;
            }
            pollutionReadings_.add(
                input.readMessage(base.pollutionSensor.PollutionReading.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return base.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return base.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            base.pollutionSensor.PollutionHistoryResponse.class, base.pollutionSensor.PollutionHistoryResponse.Builder.class);
  }

  public static final int POLLUTION_READINGS_FIELD_NUMBER = 1;
  private java.util.List<base.pollutionSensor.PollutionReading> pollutionReadings_;
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public java.util.List<base.pollutionSensor.PollutionReading> getPollutionReadingsList() {
    return pollutionReadings_;
  }
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public java.util.List<? extends base.pollutionSensor.PollutionReadingOrBuilder> 
   ...
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public base.pollutionSensor.PollutionReading getPollutionReadings(int index) {
    return pollutionReadings_.get(index);
  }
  /**
   * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
   */
  public base.pollutionSensor.PollutionReadingOrBuilder getPollutionReadingsOrBuilder(
      int index) {
    return pollutionReadings_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof base.pollutionSensor.PollutionHistoryResponse)) {
      return super.equals(obj);
    }
    base.pollutionSensor.PollutionHistoryResponse other = (base.pollutionSensor.PollutionHistoryResponse) obj;
  ...
  public static base.pollutionSensor.PollutionHistoryResponse parseFrom(
  ...
  public static base.pollutionSensor.PollutionHistoryResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static base.pollutionSensor.PollutionHistoryResponse parseFrom(
  ...
  public static base.pollutionSensor.PollutionHistoryResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static base.pollutionSensor.PollutionHistoryResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static base.pollutionSensor.PollutionHistoryResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(base.pollutionSensor.PollutionHistoryResponse prototype) {
  ...
  public static final class Builder extends
      ...
      base.pollutionSensor.PollutionHistoryResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return base.pollutionSensor.PollutionSensorImpl.internal_static_PollutionSensor_PollutionHistoryResponse_descriptor;
    }
    ...
    // Construct using base.pollutionSensor.PollutionHistoryResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public base.pollutionSensor.PollutionHistoryResponse getDefaultInstanceForType() {
      return base.pollutionSensor.PollutionHistoryResponse.getDefaultInstance();
    }

    @java.lang.Override
    public base.pollutionSensor.PollutionHistoryResponse build() {
      base.pollutionSensor.PollutionHistoryResponse result = buildPartial();
    ...
    @java.lang.Override
    public base.pollutionSensor.PollutionHistoryResponse buildPartial() {
      base.pollutionSensor.PollutionHistoryResponse result = new base.pollutionSensor.PollutionHistoryResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof base.pollutionSensor.PollutionHistoryResponse) {
        return mergeFrom((base.pollutionSensor.PollutionHistoryResponse)other);
      } else {
    ...
    public Builder mergeFrom(base.pollutionSensor.PollutionHistoryResponse other) {
      if (other == base.pollutionSensor.PollutionHistoryResponse.getDefaultInstance()) return this;
      if (pollutionReadingsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      base.pollutionSensor.PollutionHistoryResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (base.pollutionSensor.PollutionHistoryResponse) e.getUnfinishedMessage();
    ...
    private void ensurePollutionReadingsIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        pollutionReadings_ = new java.util.ArrayList<base.pollutionSensor.PollutionReading>(pollutionReadings_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        base.pollutionSensor.PollutionReading, base.pollutionSensor.PollutionReading.Builder, base.pollutionSensor.PollutionReadingOrBuilder> pollutionReadingsBuilder_;
    ...
    public Builder setPollutionReadings(
        int index, base.pollutionSensor.PollutionReading value) {
      if (pollutionReadingsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setPollutionReadings(
        int index, base.pollutionSensor.PollutionReading.Builder builderForValue) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public Builder addPollutionReadings(base.pollutionSensor.PollutionReading value) {
      if (pollutionReadingsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addPollutionReadings(
        base.pollutionSensor.PollutionReading.Builder builderForValue) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
    ...
    public Builder addAllPollutionReadings(
        java.lang.Iterable<? extends base.pollutionSensor.PollutionReading> values) {
      if (pollutionReadingsBuilder_ == null) {
        ensurePollutionReadingsIsMutable();
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public base.pollutionSensor.PollutionReading.Builder getPollutionReadingsBuilder(
        int index) {
     ...
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public base.pollutionSensor.PollutionReading.Builder addPollutionReadingsBuilder() {
    ...
    public base.pollutionSensor.PollutionReading.Builder addPollutionReadingsBuilder(
        int index) {
      return getPollutionReadingsFieldBuilder().addBuilder(
          index, base.pollutionSensor.PollutionReading.getDefaultInstance());
    }
    /**
     * <code>repeated .PollutionSensor.PollutionReading pollution_readings = 1;</code>
     */
    public java.util.List<base.pollutionSensor.PollutionReading.Builder> 
         getPollutionReadingsBuilderList() {
      return getPollutionReadingsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        base.pollutionSensor.PollutionReading, base.pollutionSensor.PollutionReading.Builder, base.pollutionSensor.PollutionReadingOrBuilder> 
        getPollutionReadingsFieldBuilder() {
      if (pollutionReadingsBuilder_ == null) {
  ...
  private static final base.pollutionSensor.PollutionHistoryResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new base.pollutionSensor.PollutionHistoryResponse();
  }

  public static base.pollutionSensor.PollutionHistoryResponse getDefaultInstance() {
